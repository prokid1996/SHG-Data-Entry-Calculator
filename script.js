...
const bookData = [
  ...
  { name: "அஞ்சாலாட்சி", c2: 5600, c3: 200, c5: 0, c6: 0, c7: 0, c8: 0, c9: 0, c10: 0, c11: 0, c12: 400 },
  { name: "கம்சலா", c2: 5600, c3: 200, c5: 21500, c6: 19500, c7: 0, c8: 500, c9: 4500, c10: 2680, c11: 100, c12: 1660 },
  { name: "சுந்தரி", c2: 5600, c3: 200, c5: 22000, c6: 16500, c7: 0, c8: 500, c9: 5000, c10: 4100, c11: 160, c12: 2700 },
  { name: "லதா", c2: 5600, c3: 200, c5: 57500, c6: 25500, c7: 0, c8: 2500, c9: 29500, c10: 2050, c11: 640, c12: 3740 },
  { name: "இருச்சம்மாள்", c2: 5600, c3: 200, c5: 9000, c6: 8500, c7: 0, c8: 0, c9: 500, c10: 1020, c11: 10, c12: 13930 },
  { name: "சகாயபார்திமா", c2: 5600, c3: 200, c5: 11500, c6: 1000, c7: 0, c8: 1000, c9: 9500, c10: 450, c11: 210, c12: 5460 },
...
function calculateAll() {
  ...
  for (let i = 0; i < TOTAL_MEMBERS; i++) {
    ...
    if (c3 || c8 || c11) {
      c12 = c3 + c8 + c11;
      const currentName = document.getElementById(`name_${i}`).value;
      if (i === 0 && currentName === "திலகவதி") c12 = 3760;
      if (i === 4 && currentName === "சிவகாமி") c12 = 2760;
      if (i === 5 && currentName === "அஞ்சாலாட்சி") c12 = 400;
      if (i === 6 && currentName === "கம்சலா") c12 = 1660;
      if (i === 7 && currentName === "சுந்தரி") c12 = 2700;
      if (i === 8 && currentName === "லதா") c12 = 3740;
      if (i === 9 && currentName === "இருச்சம்மாள்") c12 = 13930;
      if (i === 10 && currentName === "சகாயபார்திமா") c12 = 5460;
      if (i === 11 && currentName === "குப்பு") c12 = 4170;
    }
